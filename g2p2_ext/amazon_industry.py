...
def get_data(file, meta_file, dataset):
    ...
    # print('-----descrip[1122196]', review_text[1122196])
    # print('-----descrip[1122195:1122198]', review_text[1122195:1122198])
    # print('--------review_text[1141]', review_text[1141])
    ...
    print('process_1', process_1[:2])
    print('process_1_length', len(process_1))
    # process_1 = descrip
    process_2 = [preprocess_string(d, filters=CUSTOM_FILTERS) for d in review_text]
    print('process_2', process_2[:2])
    # print('--------process_2[1122196]', process_2[1122196])
    ...
    print('len(process_1)', len(sentences))
    ...
    for i in range(len(process_1)):
        ...
        if i % 100000 == 0:
            print('doc', doc)
        if doc == []:
            print('{}th'.format(i), doc)  # 8947th [] 43749th []
        vec = model.wv[doc]
    ...
    for i in range(len(process_2)):
        if process_2[i] == []:
            print("{} th doc".format(i), process_2[i])
    ...
    np.save('./data/amazon/{}_f_m.npy'.format(dataset), fea_m)
    ...
    np.save('./data/amazon/{}_edge.npy'.format(dataset), new_edge)
    ...
    json.dump(text_dict, open('./data/amazon/{}_text.json'.format(dataset), 'w'))
    ...
    json.dump(labels_dic, open('./data/amazon/{}_id_labels.json'.format(dataset), 'w'))


name = 'Industrial_and_Scientific'
file = './data/amazon/{}.json.gz'.format(name)
meta_file = './data/amazon/meta_{}.json.gz'.format(name)
