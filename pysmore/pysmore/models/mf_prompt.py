...
class mf_prompt(torch.nn.Module):
    def __init__(self, features, mlp_params=None, **kwargs):
        super(mf_prompt, self).__init__()
        ...
        self.prompt_learner = PromptLearner(
            kwargs["clip_cfg"], kwargs["clip_model"], self.num_users, kwargs["id_texts"]
        )
    ...
    def forward(self, x):
        ...
        key = "neg-i" if "neg-i" in x else "i"
